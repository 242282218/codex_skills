...
2.  **遇到特定难题**:
    ...
    - 提到“数据库报错”、“查询慢”: 自动调用 **backend-database-expert**。
...
| API 设计、项目结构、Schema | [api-design-principles](../api-design-principles/SKILL.md) |
...
| 后端、FastAPI、Python | [backend-python-expert](../backend-python-expert/SKILL.md) |
